...
<!--    </el-tabs>-->
    <div style="height: 38px;line-height:38px;border-bottom: 2px solid #E4E7ED;text-align: center; font-size: 14px">组件属性</div>
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        <!-- 表单属性 start-->
        <el-form v-if="activeData.__config__.tag === 'el-form'"  size="small" label-width="90px">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.__config__.span!==undefined && activeData.__config__.tag !== 'el-form'" label="表单栅格">
          ...
          <el-form-item  v-if="activeData.type !== undefined && activeData.__config__.tag  ===  'el-date-picker'"  label="时间类型"  >
            <el-select
